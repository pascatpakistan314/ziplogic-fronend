...
export default function Footer() {
  ...
  <img src={ziplogicLogo} alt="ZipLogic AI" width="40" height="35" className="rounded-md" />
  <span className="bg-gradient-to-r from-[#00ff88] to-[#00ddff] bg-clip-text text-transparent">ZipLogic AI</span>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="text-dark-400 hover:text-white transition">About</Link></li>
              <li><Link to="/contact" className="text-dark-400 hover:text-white transition">Contact</Link></li>
              <li><Link to="/privacy" className="text-dark-400 hover:text-white transition">Privacy</Link></li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-dark-700 mt-8 pt-8 text-center text-dark-400 text-sm">
          &copy; {new Date().getFullYear()} ZipLogic AI. All rights reserved.
        </div>
      </div>
    </footer>
  )
